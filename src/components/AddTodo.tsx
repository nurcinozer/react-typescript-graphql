...
const AddTodo: React.FC = () => {
  // After importing the useTodoMutation hook into our component, we pass in the GraphQL mutation query ADD_TODO as an argument.
  ...
  const handleSaveTodo = (
    ...
    addTodo({
      ...
      update: (
        ...
        { data: { addTodo } }: FetchResult<ITodoMutation> | any
      ) => {
        const cacheData = cache.readQuery({ query: GET_TODOS }) as ITodos;
        cache.writeQuery({
          // To preview the Todo created, we need to update the Apollo cache by spreading the old Todos with the new one in an array of Todos.
          query: GET_TODOS,
          data: {
